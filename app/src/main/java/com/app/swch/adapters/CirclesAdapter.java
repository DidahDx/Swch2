...
/* renamed from: ke.swch.adapters.CirclesAdapter */
public class CirclesAdapter extends RecyclerView.Adapter<CirclesAdapter.AddHolder> {
    private Context context;
    private List<EventGson> eventGsons;

    public CirclesAdapter(Context context2, List<EventGson> eventGsons2) {
        this.context = context2;
        this.eventGsons = eventGsons2;
    }

    public AddHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new AddHolder(LayoutInflater.from(this.context).inflate(R.layout.item_list_circle, parent, false));
    }
    ...
    /* renamed from: ke.swch.adapters.CirclesAdapter$AddHolder */
